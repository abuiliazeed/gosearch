...
## Phase 6: Crawler Enhancements 📋 Planned

> Based on research in `docs/seeding-strategies.md`

### Seed URL Management
- [ ] Predefined seed sets — General, programming, academic categories
- [ ] Seed set CLI flag — `--seed-set general|programming|academic`
- [ ] Seed set configuration file — Custom seed URLs
- [ ] Domain diversity metrics — Ensure coverage across TLDs/regions

### Crawling Strategy Improvements
- [ ] BFS crawler option — Breadth-first exploration (default recommended)
- [ ] Best-first crawler option — Priority by relevance score
- [ ] Crawl depth per domain — Configurable per-domain limits
- [ ] Crawl budget management — Total pages/time limits
