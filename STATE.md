...
## Last Updated
_2026-02-11 — Enhanced persistence, polish & quality, anti-blocking features, HTTP API server implemented_
...
| Crawler module | ✅ Complete | Frontier, Politeness, Dedupe, CollyCrawler, Anti-blocking |
...
| Crawl CLI | ✅ Complete | Wired up to crawler with auto-indexing |
...
- `types.go` - Config, URL, CrawlResult, Stats, HeaderProfile, BlockInfo, BlockDetector types ✅
